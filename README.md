...
<img src="docs/banner.png" alt="All for One — video downloader for macOS and Windows" width="100%">
...
<div align="center">
<img src="docs/screenshot.png" alt="The All for One app window: a link queue, a live download with speed and ETA, and download history" width="620">

<sub>Heads up: the app's interface is in Thai — it was built for a Thai audience first.</sub>
...
<details>
<summary><b>Do I need to install anything else — Python, ffmpeg, a browser extension?</b></summary><br>

No. Everything the app needs is bundled inside it. Download, open, paste a link.
</details>

<details>
<summary><b>Does it work on Intel Macs?</b></summary><br>

Not yet — the macOS build is Apple Silicon only (M1 and newer).
</details>

<details>
<summary><b>Can I use it on my laptop and my desktop?</b></summary><br>
...
<details>
<summary><b>Can I download private or age-restricted videos I have access to?</b></summary><br>
...
<details>
<summary><b>Is there an English interface?</b></summary><br>
...
<details>
<summary><b>Where do my downloads go?</b></summary><br>
...
<sub>Downloading is powered by the open-source <a href="https://github.com/yt-dlp/yt-dlp">yt-dlp</a> and <a href="https://ffmpeg.org">FFmpeg</a> projects, bundled inside the app.</sub>
